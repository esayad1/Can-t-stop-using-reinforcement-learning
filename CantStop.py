...
def display_debug():
    ...
    print(f"Temps d'éxécution: {round(time.time() - start_time, 2)} secondes")
    print(f"Nombre de pas moyens: {np.mean(nb_steps)}")
...
def is_over():
    ...
    """
    # Si on a 3 J1 ou J2 sur le plateau de jeu alors la partie est terminée
    if 3 in [list(board.values()).count('J1'), list(board.values()).count('J2')]:
        return True
    return False
...
def draw():
    ...
    text = font.render(f"Comb : {dices.get_combinations()}", True, (0, 0, 0))
...
# Nombre d'épisodes pour l'entraînement
nb_episodes = 1000
...
is_training = False # Est-on en train d'entraîner l'agent ?
...
#algorithm_name = "DQN"
#algorithm_name = "DDQN"
#algorithm_name = "DDQNWER"
#algorithm_name = "DDQNWPER"
#algorithm_name = "Reinforce"
algorithm_name = "ReinforceMeanBaseline"
#algorithm_name = "ReinforceBaselineCritic"
